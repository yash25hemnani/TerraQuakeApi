          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-5xl">
            ...
            {activeSection === "edit" ? (
              ...
              <div className="text-left py-4">
                <p className="text-xl text-yellow-400">🔑 Change your password here...</p>
              </div>
            ) : (
              <div className="text-left py-4">
                <p className="text-xl py-2">
                  Name: <span className="font-semibold">{userLogin.name}</span>
                </p>
                <p className="text-xl py-2">
                  Email: <span className="font-semibold">{userLogin.email}</span>
                </p> 
                <p className="text-xl py-2">
                  Role: <span className="font-semibold">{userLogin.role}</span>
                </p> 
              </div>
            )}
          </div>
