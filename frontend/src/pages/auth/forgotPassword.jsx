...
export default function forgotPassword() {
	...
	return (
		<>
			<MetaData title="Forgot Password" description="Forgot Password page of TerraQuake" />
			<section className="min-h-screen flex items-center justify-center p-6 rounded-lg">
				<div className="p-8 flex flex-col items-center justify-between h-[40rem] rounded-lg w-full">
					<h2 className="text-3xl text-center text-pink-600 font-bold">Forgot Password ?</h2>
					<form onSubmit={handleSubmit(handleForgotPassword)}>
						<div className="mb-6">
							<label className="block text-white text-sm font-semibold mb-2">Enter your email</label>
					...
					<p className="text-gray-300 text-justify">We will send you a link, if your email matches the one in our database.</p>
