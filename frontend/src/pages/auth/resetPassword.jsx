  ...
  return (
    <section className='min-h-screen flex items-center justify-center p-6 rounded-lg'>
      <div className='p-8 flex flex-col items-center justify-between h-[40rem] rounded-lg w-full'>
        ...
        <form onSubmit={handleSubmit(handleForgotPassword)}>
          <div className='relative mb-6'>
            ...
            <button
              ...
              className='absolute top-10 right-3 text-gray-300 hover:text-purple-600 cursor-pointer'
            >
        ...
        <Link
          className='mt-4 capitalize text-white hover:text-pink-600 focus:text-pink-600 duration-300 ease-in-out'
          to='/'
