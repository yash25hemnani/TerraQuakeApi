...
import { processFeatures } from "../utils/processFeatures.js";
import haversine from "haversine-distance";
>>>>>>> f79ac6229ec2a74d2a5d3bcc692a413e50f7bca4
...
>>>>>>> f79ac6229ec2a74d2a5d3bcc692a413e50f7bca4
    ...
    res.status(200).json({
      ...buildResponse(
        req,
        `Seismic events of ${year}-${month.padStart(2, "0")}`,
        result.items,
        result.totalFetched
      ),
      pagination: {
...
>>>>>>> f79ac6229ec2a74d2a5d3bcc692a413e50f7bca4
    ...
    res.status(200).json({
      ...buildResponse(
        req,
        `Seismic events in region ${region}`,
        result.items,
        result.totalFetched
      ),
      pagination: {
...
>>>>>>> f79ac6229ec2a74d2a5d3bcc692a413e50f7bca4
    ...
    res.status(200).json({
      ...buildResponse(
        req,
        `Seismic events with depth > ${depth || 0} km`,
        result.items,
        result.totalFetched
      ),
      pagination: {
...
>>>>>>> f79ac6229ec2a74d2a5d3bcc692a413e50f7bca4
    ...
    res.status(200).json({
      ...buildResponse(
        req,
        `Seismic events with magnitude >= ${mag || 0}`,
        result.items,
        result.totalFetched
      ),
      pagination: {
...
>>>>>>> f79ac6229ec2a74d2a5d3bcc692a413e50f7bca4
    ...
    if (radiusNum === null) {
      return handleHttpError(
        res,
        "The radius parameter must be a positive number",
        400
      );
    }
    ...
    const message =
      lat && lon
        ? `Seismic events near [${lat}, ${lon}] within ${radiusNum} km`
